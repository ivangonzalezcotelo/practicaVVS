...
public final class SupportedLanguages {
	...
	public static void initialize() {
		...
		/*
		 * For *simplicity*, the following variables ("options_xx") contain the
		 * language code and names in the three languages supported by
		 ...
		 * component.
		 *
		 * In a *real-life* application, this method could take a Spring service
		 * (a model facade) as a parameter for reading the language codes and
